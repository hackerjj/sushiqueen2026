...
const FALLBACK_PROMOTIONS: Promotion[] = [
  {
    ...
    discount_value: 15,
    applicable_items: [],
    image_url: '/images/promo_primera.png',
  ...
  },
  {
    ...
    description: '5 camarones empanizados con coco, arroz yakimeshi, verduras asadas y una kushiage de manchego.',
    discount_type: 'fixed',
    discount_value: 215,
    applicable_items: [],
  ...
  },
  {
    ...
    discount_value: 0,
    applicable_items: [],
    image_url: '/images/promo1-2x1.png',
    starts_at: '2026-01-01T00:00:00Z',
    expires_at: '2026-06-30T23:59:59Z',
    active: true,
    code: 'MAKI2X1',
