import{p as C,j as e,e as S}from"./index-BPtJ80xi.js";import{r as d,u as L,L as g,e as T}from"./vendor-D4a7IXu9.js";import{c as q}from"./state-DpbG-6tL.js";import{a as M}from"./api-kkEpVO6i.js";import{m as P}from"./menuData-SpH9tcNn.js";const w=q()(C((s,r)=>({items:[],addItem:a=>s(i=>i.items.find(n=>n.menu_item_id===a.menu_item_id)?{items:i.items.map(n=>n.menu_item_id===a.menu_item_id?{...n,quantity:n.quantity+a.quantity}:n)}:{items:[...i.items,a]}),removeItem:a=>s(i=>({items:i.items.filter(o=>o.menu_item_id!==a)})),updateQuantity:(a,i)=>s(o=>i<=0?{items:o.items.filter(n=>n.menu_item_id!==a)}:{items:o.items.map(n=>n.menu_item_id===a?{...n,quantity:i}:n)}),clearCart:()=>s({items:[]}),getTotal:()=>{const{items:a}=r();return a.reduce((i,o)=>{const n=o.modifiers.reduce((c,t)=>c+t.price,0);return i+(o.price+n)*o.quantity},0)},getItemCount:()=>{const{items:a}=r();return a.reduce((i,o)=>i+o.quantity,0)}}),{name:"sushi-queen-cart"})),z=({onCartOpen:s})=>{const[r,a]=d.useState(!1),i=L(),o=w(t=>t.getItemCount()),n=[{to:"/",label:"Home"},{to:"/menu",label:"Menú"},{to:"/promotions",label:"Promociones"},{to:"/order",label:"Ordenar"}],c=t=>i.pathname===t;return e.jsxs("header",{className:"bg-sushi-secondary sticky top-0 z-50 shadow-lg",children:[e.jsx("div",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8",children:e.jsxs("div",{className:"flex items-center justify-between h-16",children:[e.jsxs(g,{to:"/",className:"flex items-center gap-2",children:[e.jsx("img",{src:"/images/logo.png",alt:"Sushi Queen",className:"h-10 w-10 object-contain"}),e.jsxs("span",{className:"font-display text-xl font-bold text-white",children:["Sushi ",e.jsx("span",{className:"text-sushi-accent",children:"Queen"})]})]}),e.jsx("nav",{className:"hidden md:flex items-center gap-1",children:n.map(t=>e.jsx(g,{to:t.to,className:`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${c(t.to)?"bg-sushi-primary text-white":"text-gray-300 hover:text-white hover:bg-white/10"}`,children:t.label},t.to))}),e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsxs("button",{onClick:s,className:"relative p-2 text-gray-300 hover:text-white transition-colors","aria-label":"Abrir carrito",children:[e.jsx("svg",{className:"w-6 h-6",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 100 4 2 2 0 000-4z"})}),o>0&&e.jsx("span",{className:"absolute -top-1 -right-1 bg-sushi-primary text-white text-xs font-bold rounded-full w-5 h-5 flex items-center justify-center",children:o})]}),e.jsx("button",{onClick:()=>a(!r),className:"md:hidden p-2 text-gray-300 hover:text-white","aria-label":"Abrir menú",children:r?e.jsx("svg",{className:"w-6 h-6",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M6 18L18 6M6 6l12 12"})}):e.jsx("svg",{className:"w-6 h-6",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M4 6h16M4 12h16M4 18h16"})})})]})]})}),r&&e.jsx("div",{className:"md:hidden bg-sushi-secondary border-t border-white/10",children:e.jsx("nav",{className:"px-4 py-3 space-y-1",children:n.map(t=>e.jsx(g,{to:t.to,onClick:()=>a(!1),className:`block px-4 py-3 rounded-lg text-sm font-medium transition-colors ${c(t.to)?"bg-sushi-primary text-white":"text-gray-300 hover:text-white hover:bg-white/10"}`,children:t.label},t.to))})})]})},E="5517966419",D=`https://wa.me/${E}?text=Hola%20Sushi%20Queen!%20Quiero%20hacer%20un%20pedido`,Q=()=>e.jsx("footer",{className:"bg-sushi-secondary text-gray-300",children:e.jsxs("div",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12",children:[e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-8",children:[e.jsxs("div",{children:[e.jsxs("div",{className:"flex items-center gap-2 mb-4",children:[e.jsx("img",{src:"/images/logo.png",alt:"Sushi Queen",className:"h-10 w-10 object-contain"}),e.jsxs("span",{className:"font-display text-xl font-bold text-white",children:["Sushi ",e.jsx("span",{className:"text-sushi-accent",children:"Queen"})]})]}),e.jsx("p",{className:"text-sm leading-relaxed",children:"El mejor sushi de la Colonia Obrera, CDMX. Ingredientes frescos, preparación artesanal y un ambiente familiar con temática de michis 🐱"}),e.jsx("p",{className:"text-xs text-gray-500 mt-2",children:"⭐ 4.6 · 160 reseñas en Google Maps"})]}),e.jsxs("div",{children:[e.jsx("h3",{className:"text-white font-semibold mb-4",children:"Navegación"}),e.jsxs("ul",{className:"space-y-2 text-sm",children:[e.jsx("li",{children:e.jsx(g,{to:"/",className:"hover:text-sushi-accent transition-colors",children:"Home"})}),e.jsx("li",{children:e.jsx(g,{to:"/menu",className:"hover:text-sushi-accent transition-colors",children:"Menú"})}),e.jsx("li",{children:e.jsx(g,{to:"/promotions",className:"hover:text-sushi-accent transition-colors",children:"Promociones"})}),e.jsx("li",{children:e.jsx(g,{to:"/order",className:"hover:text-sushi-accent transition-colors",children:"Ordenar"})})]})]}),e.jsxs("div",{children:[e.jsx("h3",{className:"text-white font-semibold mb-4",children:"Contacto"}),e.jsxs("ul",{className:"space-y-3 text-sm",children:[e.jsxs("li",{className:"flex items-center gap-2",children:[e.jsx("svg",{className:"w-4 h-4 text-sushi-accent",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"})}),"55 1796 6419"]}),e.jsxs("li",{className:"flex items-center gap-2",children:[e.jsx("svg",{className:"w-4 h-4 text-sushi-accent",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"})}),"sushiqueen.mx"]}),e.jsxs("li",{className:"flex items-center gap-2",children:[e.jsxs("svg",{className:"w-4 h-4 text-sushi-accent",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:[e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"}),e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M15 11a3 3 0 11-6 0 3 3 0 016 0z"})]}),"Jose T. Cuellar 39, Obrera, Cuauhtémoc, 06800 CDMX"]}),e.jsxs("li",{className:"flex items-center gap-2",children:[e.jsx("svg",{className:"w-4 h-4 text-sushi-accent",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"})}),"Lun-Dom: 1:00 PM - 10:00 PM"]})]}),e.jsxs("div",{className:"flex items-center gap-4 mt-4",children:[e.jsx("a",{href:D,target:"_blank",rel:"noopener noreferrer",className:"bg-green-500 hover:bg-green-600 text-white p-2 rounded-full transition-colors","aria-label":"WhatsApp",children:e.jsx("svg",{className:"w-5 h-5",fill:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{d:"M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"})})}),e.jsx("a",{href:"https://www.instagram.com/sushiqueenmx",target:"_blank",rel:"noopener noreferrer",className:"text-gray-400 hover:text-sushi-accent transition-colors","aria-label":"Instagram",children:e.jsx("svg",{className:"w-5 h-5",fill:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{d:"M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z"})})}),e.jsx("a",{href:"https://www.facebook.com/sushiqueenmx/",target:"_blank",rel:"noopener noreferrer",className:"text-gray-400 hover:text-sushi-accent transition-colors","aria-label":"Facebook",children:e.jsx("svg",{className:"w-5 h-5",fill:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{d:"M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"})})})]})]})]}),e.jsxs("div",{className:"border-t border-white/10 mt-8 pt-8 text-center text-sm text-gray-500",children:["© ",new Date().getFullYear()," Sushi Queen. Desarrollado por MexInTouch. Todos los derechos reservados."]})]})});function A(){const{items:s,addItem:r,removeItem:a,updateQuantity:i,clearCart:o,getTotal:n,getItemCount:c}=w(),t=(b,N=1)=>{const j={menu_item_id:b._id,name:b.name,quantity:N,price:b.price,modifiers:[]};r(j),S(j)},m=n(),h=0,f=m,u=c();return{items:s,addItem:r,addMenuItem:t,removeItem:a,updateQuantity:i,clearCart:o,subtotal:m,tax:h,total:f,itemCount:u}}function k(s){return"$"+s.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})}function _(s){return Number.isInteger(s)?"$"+s.toLocaleString("en-US"):k(s)}const O=({item:s})=>{const{updateQuantity:r,removeItem:a}=w(),i=s.modifiers.reduce((n,c)=>n+c.price,0),o=(s.price+i)*s.quantity;return e.jsxs("div",{className:"flex items-start gap-3 py-4 border-b border-gray-100 last:border-0",children:[e.jsxs("div",{className:"flex-1 min-w-0",children:[e.jsx("h4",{className:"font-medium text-sushi-secondary text-sm truncate",children:s.name}),s.modifiers.length>0&&e.jsx("p",{className:"text-xs text-gray-400 mt-0.5",children:s.modifiers.map(n=>n.name).join(", ")}),s.notes&&e.jsx("p",{className:"text-xs text-gray-400 italic mt-0.5",children:s.notes}),e.jsx("p",{className:"text-sm font-semibold text-sushi-primary mt-1",children:_(o)})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("button",{onClick:()=>r(s.menu_item_id,s.quantity-1),className:"w-7 h-7 rounded-full bg-gray-100 hover:bg-gray-200 flex items-center justify-center text-sm font-bold text-gray-600 transition-colors","aria-label":"Reducir cantidad",children:"−"}),e.jsx("span",{className:"text-sm font-medium w-5 text-center",children:s.quantity}),e.jsx("button",{onClick:()=>r(s.menu_item_id,s.quantity+1),className:"w-7 h-7 rounded-full bg-gray-100 hover:bg-gray-200 flex items-center justify-center text-sm font-bold text-gray-600 transition-colors","aria-label":"Aumentar cantidad",children:"+"})]}),e.jsx("button",{onClick:()=>a(s.menu_item_id),className:"text-gray-300 hover:text-sushi-primary transition-colors p-1","aria-label":"Eliminar item",children:e.jsx("svg",{className:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"})})})]})},B=({subtotal:s,total:r})=>e.jsxs("div",{className:"border-t border-gray-200 pt-4 space-y-2",children:[e.jsxs("div",{className:"flex justify-between text-sm text-gray-600",children:[e.jsx("span",{children:"Subtotal"}),e.jsx("span",{children:k(s)})]}),e.jsx("div",{className:"flex justify-between text-xs text-gray-400",children:e.jsx("span",{children:"IVA incluido"})}),e.jsxs("div",{className:"flex justify-between text-lg font-bold text-sushi-secondary pt-2 border-t border-gray-100",children:[e.jsx("span",{children:"Total"}),e.jsx("span",{children:k(r)})]})]}),I=({open:s,onClose:r})=>{const{items:a,subtotal:i,tax:o,total:n,clearCart:c}=A(),t=T(),m=()=>{r(),t("/order")};return e.jsxs(e.Fragment,{children:[s&&e.jsx("div",{className:"fixed inset-0 bg-black/50 z-40 transition-opacity",onClick:r}),e.jsx("div",{className:`fixed top-0 right-0 h-full w-full max-w-md bg-white z-50 shadow-2xl transform transition-transform duration-300 ease-in-out ${s?"translate-x-0":"translate-x-full"}`,children:e.jsxs("div",{className:"flex flex-col h-full",children:[e.jsxs("div",{className:"flex items-center justify-between px-6 py-4 border-b border-gray-100",children:[e.jsx("h2",{className:"text-lg font-bold text-sushi-secondary",children:"Tu Pedido"}),e.jsx("button",{onClick:r,className:"p-2 text-gray-400 hover:text-gray-600 transition-colors","aria-label":"Cerrar carrito",children:e.jsx("svg",{className:"w-5 h-5",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M6 18L18 6M6 6l12 12"})})})]}),e.jsx("div",{className:"flex-1 overflow-y-auto px-6",children:a.length===0?e.jsxs("div",{className:"flex flex-col items-center justify-center h-full text-gray-400",children:[e.jsx("svg",{className:"w-16 h-16 mb-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:1.5,d:"M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 100 4 2 2 0 000-4z"})}),e.jsx("p",{className:"text-sm",children:"Tu carrito está vacío"}),e.jsx("button",{onClick:()=>{r(),t("/menu")},className:"mt-4 text-sushi-primary text-sm font-medium hover:underline",children:"Ver menú"})]}):e.jsx("div",{className:"py-2",children:a.map(h=>e.jsx(O,{item:h},h.menu_item_id))})}),a.length>0&&e.jsxs("div",{className:"px-6 py-4 border-t border-gray-100 space-y-4",children:[e.jsx(B,{subtotal:i,tax:o,total:n}),e.jsxs("div",{className:"flex gap-3",children:[e.jsx("button",{onClick:c,className:"flex-1 py-3 border border-gray-300 rounded-lg text-sm font-medium text-gray-600 hover:bg-gray-50 transition-colors",children:"Vaciar"}),e.jsxs("button",{onClick:m,className:"flex-[2] btn-primary text-center",children:["Ordenar · $",n.toLocaleString("en-US",{minimumFractionDigits:2})]})]})]})]})})]})},W={id:"welcome",role:"assistant",content:`¡Hola! 🍣 Soy el asistente virtual de Sushi Queen. Puedo ayudarte con:
...
¿En qué te puedo ayudar?`,timestamp:new Date},H=()=>{const[s,r]=d.useState(!1),[a,i]=d.useState([W]),[o,n]=d.useState(""),[c,t]=d.useState(!1),[m,h]=d.useState(P),f=d.useRef(null),u=d.useRef(null);d.useEffect(()=>{(async()=>{var y;try{const x=(y=(await M.get("/menu")).data)==null?void 0:y.data;if(x&&typeof x=="object"){const v=Object.values(x).flat();v.length>0&&h(v)}}catch{}})()},[]),d.useEffect(()=>{var l;(l=f.current)==null||l.scrollIntoView({behavior:"smooth"})},[a]),d.useEffect(()=>{var l;s&&((l=u.current)==null||l.focus())},[s]);const b=async()=>{var y;if(!o.trim()||c)return;const l={id:Date.now().toString(),role:"user",content:o.trim(),timestamp:new Date};i(p=>[...p,l]),n(""),t(!0);try{const{data:p}=await M.post("/ai/chat",{message:l.content}),x={id:(Date.now()+1).toString(),role:"assistant",content:((y=p.data)==null?void 0:y.response)||p.message||$(l.content,m),timestamp:new Date};i(v=>[...v,x])}catch{const p={id:(Date.now()+1).toString(),role:"assistant",content:$(l.content,m),timestamp:new Date};i(x=>[...x,p])}finally{t(!1)}},N=l=>{l.key==="Enter"&&!l.shiftKey&&(l.preventDefault(),b())},j=[{label:"📋 Ver menú",msg:"Quiero ver el menú completo"},{label:"⭐ Recomendaciones",msg:"Qué me recomiendas?"},{label:"📍 Ubicación",msg:"Dónde están ubicados?"},{label:"🛒 Ordenar",msg:"Quiero hacer un pedido"}];return e.jsxs(e.Fragment,{children:[e.jsx("button",{onClick:()=>r(!s),className:"fixed bottom-6 right-6 z-50 bg-sushi-primary hover:bg-red-700 text-white rounded-full w-14 h-14 flex items-center justify-center shadow-lg transition-all hover:scale-105","aria-label":"Abrir chat de asistencia",children:s?e.jsx("svg",{className:"w-6 h-6",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M6 18L18 6M6 6l12 12"})}):e.jsx("svg",{className:"w-6 h-6",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"})})}),s&&e.jsxs("div",{className:"fixed bottom-24 right-6 z-50 w-[380px] max-w-[calc(100vw-2rem)] bg-white rounded-2xl shadow-2xl border border-gray-200 flex flex-col overflow-hidden",style:{height:"520px"},children:[e.jsxs("div",{className:"bg-sushi-secondary px-4 py-3 flex items-center gap-3",children:[e.jsx("div",{className:"w-9 h-9 bg-sushi-accent rounded-full flex items-center justify-center text-lg",children:"🍣"}),e.jsxs("div",{className:"flex-1",children:[e.jsx("h3",{className:"text-white font-semibold text-sm",children:"Sushi Queen AI"}),e.jsx("p",{className:"text-gray-400 text-xs",children:"Asistente virtual · En línea"})]}),e.jsx("div",{className:"w-2 h-2 bg-green-400 rounded-full animate-pulse"})]}),e.jsxs("div",{className:"flex-1 overflow-y-auto p-4 space-y-3 bg-gray-50",children:[a.map(l=>e.jsx("div",{className:`flex ${l.role==="user"?"justify-end":"justify-start"}`,children:e.jsx("div",{className:`max-w-[85%] px-3 py-2 rounded-2xl text-sm whitespace-pre-wrap leading-relaxed ${l.role==="user"?"bg-sushi-primary text-white rounded-br-md":"bg-white text-gray-700 border border-gray-200 rounded-bl-md shadow-sm"}`,children:l.content})},l.id)),c&&e.jsx("div",{className:"flex justify-start",children:e.jsx("div",{className:"bg-white border border-gray-200 rounded-2xl rounded-bl-md px-4 py-3 shadow-sm",children:e.jsxs("div",{className:"flex gap-1",children:[e.jsx("div",{className:"w-2 h-2 bg-gray-400 rounded-full animate-bounce",style:{animationDelay:"0ms"}}),e.jsx("div",{className:"w-2 h-2 bg-gray-400 rounded-full animate-bounce",style:{animationDelay:"150ms"}}),e.jsx("div",{className:"w-2 h-2 bg-gray-400 rounded-full animate-bounce",style:{animationDelay:"300ms"}})]})})}),a.length<=2&&!c&&e.jsx("div",{className:"flex flex-wrap gap-2",children:j.map(l=>e.jsx("button",{onClick:()=>{n(l.msg)},className:"text-xs bg-white border border-gray-200 text-gray-600 px-3 py-1.5 rounded-full hover:bg-sushi-primary/5 hover:border-sushi-primary/30 transition-colors",children:l.label},l.label))}),e.jsx("div",{ref:f})]}),e.jsx("div",{className:"p-3 border-t border-gray-200 bg-white",children:e.jsxs("div",{className:"flex gap-2",children:[e.jsx("input",{ref:u,type:"text",value:o,onChange:l=>n(l.target.value),onKeyDown:N,placeholder:"Escribe tu mensaje...",className:"flex-1 px-3 py-2 border border-gray-300 rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-sushi-primary/20 focus:border-sushi-primary"}),e.jsx("button",{onClick:b,disabled:!o.trim()||c,className:"bg-sushi-primary hover:bg-red-700 disabled:opacity-50 text-white rounded-full w-9 h-9 flex items-center justify-center transition-colors","aria-label":"Enviar mensaje",children:e.jsx("svg",{className:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M12 19l9 2-9-18-9 18 9-2zm0 0v-8"})})})]})})]})]})};function $(s,r){const a=s.toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g,"");if(/^(hola|hey|buenas|buenos|que tal|hi|hello|ola|saludos)/.test(a))return`¡Hola! 👋 Bienvenido a Sushi Queen, el mejor sushi de la Colonia Obrera en CDMX.
...
¿Qué te gustaría ordenar?`;if(/menu completo|todo el menu|ver menu|ver el menu|carta|que tienen|que hay/.test(a)){const n=[...new Set(r.map(t=>t.category))],c=n.map(t=>{const m=r.filter(u=>u.category===t),h=Math.min(...m.map(u=>u.price)),f=Math.max(...m.map(u=>u.price));return`• ${t} (${m.length} platillos) - $${h} a $${f}`}).join(`
`);return`📋 Nuestro menú tiene ${r.length}+ platillos en ${n.length} categorías:
...
📞 Si tienes dudas, llámanos al 55 1796 6419.`;const i=a.split(/\s+/),o=r.filter(n=>{const c=(n.name+" "+n.description).toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g,"");return i.some(t=>t.length>3&&c.includes(t))});return o.length>0&&o.length<=8?`Encontré esto en nuestro menú:

${o.map(c=>`• ${c.name} - $${c.price}
  ${c.description}`).join(`
...
¿Qué te gustaría saber? 🍣`}const K=({children:s})=>{const[r,a]=d.useState(!1);return e.jsxs("div",{className:"min-h-screen flex flex-col bg-sushi-bg",children:[e.jsx(z,{onCartOpen:()=>a(!0)}),e.jsx("main",{className:"flex-1",children:s}),e.jsx(Q,{}),e.jsx(I,{open:r,onClose:()=>a(!1)}),e.jsx(H,{})]})};export{O as C,K as L,B as a,_ as f,A as u};
